...
if cpu_type_intel == cpu_type:
    print("""          Options 1:Intel i9 12900k 
          Options 2:Intel i7 12700k
          Options 3:Intel i5 12400
          Options 4:Inel  i3 12100f
          Options 5:Intel i9 11900k
          Options 6:Intel i7 11700K
          options 7:Intel i5 11500k
          Options 8:Intel i3 11400f""")
    cpu_intel = input("Which Cpu? ")
# cost for cpu and mother board


cost_i7 = 374
cost_motherboard2 = 180
cost_both_2 = (cost_i7 + cost_motherboard2)

cost_i5 = 284
cost_motherboard_3 = 125
cost_both_3 = (cost_i5 + cost_motherboard_33)

cost_i3 = 84
cost_motherboard_4 =80
cost_both_4 = (cost_i3 + cost_motherboard_4)


if intelCpu_12_9 == cpu_intel:
      print(intel_motherboard_12, prompts,cost_both, sep = "")
cost_i9 = 615
cost_motherboard = 270
cost_both = (cost_i9 + cost_motherboard)
prompts = ("The total cost for one:$")

if intelCpu_12_7== cup_intel:
     print(intel_motherboard_12, prompts,cost_both_2, sep="")
     
if intelCpu_12_5 == cpu_intel:
     print(intel_motherboard_12, prompts,cost_both_3, sep=="")
     
if intelCpu_12_3 == cpu_intel:
     print(intel_motherboard_12, prompts,cost_both_4, sep=="")



#amd cpu and if statement with motherboard
   
##if cpu_type_amd == cpu_type:
...
##    
##    cpu_amd = input("Which Cpu? ")
##
###Amd cpu- COmpatiability
##
##if amdCpu_5000_9 == cpu_amd:
##    print(amd_motherboard_5000)
##if amdCpu_5000_9 == cpu_amd:
##    print(amd_motherboard_5000)
##if amdCpu_5000_7 == cpu_amd:
##    print(amd_motherboard_5000)
##if amdCpu_5000_5 == cpu_amd:
##    print(amd_motherboard_5000)
